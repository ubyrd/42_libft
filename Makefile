...
#    Updated: 2019/05/21 15:13:50 by ubyrd            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_NAME		=	ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c \
					...
					\
					ft_abs.c ft_factorial.c ft_power.c ft_sqrt.c \
					ft_atoi_base.c ft_itoa_base.c ft_gcd.c ft_nextprime.c \
					\
					ft_btree_create_node.c ft_btree_delone.c \
					ft_btree_apply_prefix.c ft_btree_apply_infix.c \
